  ...
  return(
    ...
    <div className='flex flex-col items-center justify-center min-h-screen text-white p-4'>
      ...
      <main className='flex flex-col items-center justify-center text-center flex-grow'>
        ...
        <input className='flex-grow p-3 bg-transparent border-none rounded-md text-gray-200 placeholder-gray-400 px-5' type='url' placeholder='https://your-lengthy-url.com' value={originalUrl} onChange={(e)=>setOriginalUrl(e.target.value) } required />
